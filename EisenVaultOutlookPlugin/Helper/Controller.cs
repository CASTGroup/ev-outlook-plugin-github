...
namespace EisenVaultOutlookPlugin.Helper
{
    public class Controller
    {
        ...
        public async Task<bool> UploadEmailDateTime(Outlook.MailItem item, string nodeId, DateTime date)
        {
            try
            {
                ...
                string dateDay = date.ToString("yyyyMMdd");
                string dateTime = date.ToString("HHmmss");

                string alt = $"{filename}_{dateDay}{dateTime}";
